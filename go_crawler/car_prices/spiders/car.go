...
func GetCurrentPage(doc *goquery.Document) (page int) {
	pageStr := doc.Find(".page .current").Text()

	if pageStr != "" {
		var err error
		page, err = strconv.Atoi(pageStr)
		if err != nil {
			logging.Error("spiders.GetCurrentPage err: %v", err)
		}
	}
...
func GetCar(doc *goquery.Document) (cars []QcCar) {
	cityName := GetCityName(doc)
	doc.Find(".piclist ul li:not(.line)").Each(
		func(i int, s *goquery.Selection) {
			...
			kilometerF, _ := strconv.ParseFloat(kilometer, 64)
