...
type SuperstarService interface {
	...
	Update(user *models.StarInfo, cloumns []string) error
...
func (s *superstarService) Update(user *models.StarInfo, cloumns []string) error {
	return s.dao.Update(user, cloumns)
}
