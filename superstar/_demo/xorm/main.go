...
const MasterDataSourceName = "gouser:123456@(192.168.247.133)/superstar?charset=utf8&parseTime=True&loc=Local"
...
func newEgine() *xorm.Engine {
	engine, err := xorm.NewEngine(DriverName, MasterDataSourceName)
	if err != nil {
		logging.Error("new xorm engine failed, err:%v", err)
		return nil
	}
